...
export function OnboardingShell({
  ...
  return (
    <div className='fixed inset-0 z-[200] overflow-x-hidden overflow-y-auto bg-slate-50 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent overscroll-y-contain'>
      ...
      <div className='relative z-10 flex min-h-full flex-col items-center px-4 py-8 sm:px-6 sm:py-10'>
        ...
        >
          {showPreview && (
            <div className='w-full max-w-sm mx-auto lg:max-w-none lg:sticky lg:top-8'>
              {preview}
            </div>
          )}
