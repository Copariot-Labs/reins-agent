export default {
  ...
  sidebar: {
    ...
    collapse: '收起選單',
    expand: '展開選單',
    updateTip: '下載並安裝最新版本的 Reins',
    updateVersion: '升級版本 v{version}',
    reloadClientVersion: '重新整理到 v{version}',
    updating: '正在更新...',
    updateSuccess: '更新已開始，完成後 Reins 將自動重新啟動。',
    updateFailed: '更新失敗',
    logout: '登出',
  ...
  workmode: {
    ...
    form: {
      task: '任務',
      placeholder: '輸入需要背景執行、可見展示和產物記錄的任務。',
    },
    examples: {
      report: '為住戶漏水報修產生處理報告',
      browser: '開啟瀏覽器證據用於政策查詢',
      wechat: '準備微信訊息並等待確認',
    },
    status: {
      label: '狀態',
    ...
    messages: {
      taskRequired: '請輸入任務',
      finished: '工作模式執行完成',
      finishedWithFailure: '工作模式執行結束，但存在失敗',
      cancelled: '工作模式執行已取消',
      failed: '工作模式執行失敗',
      historyLoaded: '已載入工作模式歷史',
      historyLoadFailed: '載入工作模式歷史失敗',
      confirmationRequired: '動作正在等待操作員確認',
      confirmationApproved: '已確認',
      confirmationRejected: '已拒絕',
      confirmationFailed: '確認操作失敗',
    },
  },
  ...
  finance: {
    ...
    form: {
      addTitle: '新增交易',
      editTitle: '編輯交易',
      requiredHint: '標有 * 的項目為必填項，標有「選填」的項目可不填寫。',
      optionalLabel: '{label}（選填）',
      type: '類型',
      typePlaceholder: '請選擇交易類型',
      amount: '金額',
      amountPlaceholder: '請輸入金額',
      currency: '幣種',
      currencyPlaceholder: '請輸入幣種代碼',
      date: '日期',
      category: '分類',
      categoryPlaceholder: '選擇或輸入分類',
      paymentMethod: '付款方式',
      paymentMethodPlaceholder: '選擇或輸入付款方式',
      description: '描述',
      descriptionPlaceholder: '請輸入交易描述',
      counterparty: '交易對象',
      counterpartyPlaceholder: '請輸入交易對象（選填）',
      amountRequired: '請輸入大於零的金額。',
      currencyRequired: '請輸入幣種。',
      dateRequired: '請選擇交易日期。',
      categoryRequired: '請輸入分類。',
      descriptionRequired: '請輸入描述。',
      descriptionTooLong: '描述不能超過 {max} 個字。',
    },
  },
  ...
  workOrders: {
    ...
    lastUpdated: '最後更新',
    loadFailed: '載入工單失敗',
    detailFailed: '載入工單詳情失敗',
    exportSuccess: 'Excel 台帳已下載',
    exportFailed: '下載 Excel 台帳失敗',
    actions: {
      refresh: '重新整理',
    ...
    stats: {
      ...
      processing: '處理中',
      urgent: '緊急',
      notificationFailed: '通知失敗',
      completed: '已完成',
    },
    filters: {
      searchPlaceholder: '搜尋工單、地點、問題或員工',
      status: '處理狀態',
      priority: '優先級',
      department: '負責部門',
      category: '問題類別',
    ...
    status: {
      new: '新建',
      open: '待處理',
      pendingNotification: '待通知',
      waitingHumanReview: '待人工確認',
      notified: '已通知',
      processing: '處理中',
      resolved: '已解決',
      closed: '已關閉',
    ...
    notification: {
      sent: '已發送',
      dryRun: '僅預覽',
      pendingConfiguration: '待設定',
      skippedDuplicate: '重複已略過',
      failed: '發送失敗',
      disabled: '已停用',
    },
    detail: {
  ...
  chat: {
    ...
    openHistory: '開啟歷史',
    hermesHistory: 'Reins 歷史',
    historyScopeHint: '這裡按來源以唯讀方式查看目前 profile 的 Reins 歷史工作階段。',
    noSessions: '目前無工作階段',
    searchTitle: '搜尋工作階段',
    searchSubtitle: '依標題或訊息內容搜尋',
    searchScope: '搜尋範圍：僅 Web UI 本地工作階段資料庫；不包含唯讀 Reins 歷史工作階段。',
  ...
  plugins: {
    title: '插件',
    refresh: '重新整理',
    notice: '唯讀顯示可發現的 Reins 插件 manifest。發現元資料讀取不會載入插件程式碼。v1 管理動作仍保留在 CLI，新 Reins 工作階段生效。',
    loadFailed: '載入插件失敗',
    commandCopied: '指令已複製',
  ...
  models: {
    ...
    copilotAddDetected: '已在本機偵測到 GitHub Copilot OAuth 憑證，點擊「新增」即可在 Reins 中啟用 Copilot。',
    copilotAddSourceEnv: '來源：~/.reins/.env（COPILOT_GITHUB_TOKEN）',
    copilotAddSourceGhCli: '來源：gh CLI（gh auth token）',
    copilotAddSourceAppsJson: '來源：VS Code Copilot 插件（apps.json）',
    copilotDeleteHintEnv: '此操作會清除 ~/.reins/.env 中的 COPILOT_GITHUB_TOKEN，不影響其他工具。',
    copilotDeleteHintGhCli: 'Copilot 將從 Reins 清單移除。不會影響 gh CLI —— `gh auth status` 仍顯示已登入。',
    copilotDeleteHintAppsJson: 'Copilot 將從 Reins 清單移除。不會影響 VS Code Copilot 插件的登入。',
    customBadge: '自訂',
    previewBadge: '預覽',
    disabledBadge: '不可用',
    ...
    visibilityHint: '僅影響 Web UI 的模型選擇器和模型頁展示，不會改寫 Reins CLI 的 provider/model 配置。實際呼叫仍使用原始模型 ID。',
    ...
    aliasHint: '僅修改 Web UI 顯示名，傳送給 Reins 的仍是原始模型 ID。',
  ...
  profiles: {
    ...
    rename: '重新命名',
    delete: '刪除',
    switchTo: '切換 Reins Profile',
    switchConfirm: '將執行 `reins profile use {name}` 並切換 Reins CLI 的 active profile，是否繼續？',
    switchSuccess: 'Reins active profile 已切換為「{name}」',
    switchFailed: '切換 Reins Profile 失敗，閘道可能需要手動重新啟動',
  ...
  platform: {
    ...
    weixinTokenHint: '透過 weixin CLI 掃碼登入取得 (reins weixin)',
  ...
  skillsUsage: {
    title: '技能用量',
    subtitle: '追蹤 Reins 工作階段中的技能載入與編輯',
    refresh: '重新整理',
  ...
  changelog: {
    ...
    new_0_6_3_2: 'History 新增 Reins CLI 工作階段匯入控制，並在匯入時更安全地規範化訊息結構',
    new_0_6_3_3: 'Provider 設定支援編輯內建 base URL，新增 LM Studio 內建 Provider，並支援從 LM Studio /models 即時發現模型',
    new_0_6_3_4: '透過 Web UI bridge 發起的 OpenRouter 請求會攜帶 Reins Web UI 應用歸因 headers',
    ...
    new_0_6_2_10: '預設上下文長度遵循 Reins 規範，調整為 256,000 tokens',
    ...
    new_0_5_34_2: '自訂 Reins 模型改由後端設定持久化，並新增新增/移除模型介面',
    ...
    new_0_5_34_8: '如果 Windows 下看板功能異常，請升級 Reins 以取得最新的看板資料庫遷移修復',
    ...
    new_0_6_0_1: '分帳戶、分 Profile 管理現在一致保護工作階段、模型、用量、看板、任務、上傳、媒體與相關 Reins API',
    new_0_6_0_2: '內建媒體 Skills 只會在媒體端點使用產生的伺服器 token，並依請求的 Profile 讀取 fun-codex/xAI 憑證',
    new_0_6_0_3: '單聊與群聊都會把目前 Reins Profile 注入執行提示，方便 Skills 請求時帶上 X-Reins-Profile',
    ...
    new_0_6_1_2: 'Clarify 與確認回覆現在會透過已鑑權的聊天 socket 傳到 Reins bridge，並補上回應鏈路測試',
