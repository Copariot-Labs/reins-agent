export default {
  ...
  sidebar: {
    ...
    updateTip: 'Die neueste Reins-Version herunterladen und installieren',
    updateVersion: 'Aktualisieren auf v{version}',
    reloadClientVersion: 'Für v{version} neu laden',
    updating: 'Aktualisierung...',
    updateSuccess: 'Das Update wurde gestartet. Reins startet danach automatisch neu.',
  ...
  chat: {
    ...
    contextEditHint: 'Häufige Werte: 256k (Reins-Standard), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Starten Sie eine Konversation mit Reins Agent',
    ...
    hermesHistory: 'Reins-Verlauf',
    historyScopeHint: 'Schreibgeschützte Reins-Verlaufssitzungen des aktuellen Profils, nach Quelle gruppiert.',
    ...
    searchScope: 'Suchbereich: nur lokale Web-UI-Sitzungsdatenbank; schreibgeschützte Reins-Verlaufssitzungen sind nicht enthalten.',
...
jobTriggered: 'Job ausgelost',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Aktualisieren',
    notice: 'Schreibgeschütztes Inventar erkennbarer Reins-Plugin-Manifeste. Discovery-Metadaten werden gelesen, ohne Plugin-Code zu laden. Verwaltungsaktionen bleiben in v1 im CLI; Änderungen gelten für neue Reins-Sitzungen.',
  ...
  models: {
    ...
    copilotAddDetected: 'Auf diesem Rechner wurde ein GitHub Copilot OAuth-Token erkannt. Klicken Sie auf „Hinzufügen", um Copilot in Reins zu aktivieren.',
    copilotAddSourceEnv: 'Quelle: ~/.reins/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Quelle: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Quelle: VS Code Copilot-Erweiterung (apps.json)',
    copilotDeleteHintEnv: 'Dies löscht COPILOT_GITHUB_TOKEN in ~/.reins/.env. Andere Tools sind nicht betroffen.',
    copilotDeleteHintGhCli: 'Copilot wird aus Reins ausgeblendet. Ihre gh CLI-Anmeldung bleibt erhalten — `gh auth status` zeigt weiterhin als angemeldet.',
    copilotDeleteHintAppsJson: 'Copilot wird aus Reins ausgeblendet. Ihre VS Code Copilot-Erweiterung bleibt angemeldet.',
    ...
    visibilityHint: 'Wirkt sich nur auf Modellauswahl und Modellseite der Web UI aus. Die provider/model-Konfiguration der Reins CLI wird nicht geändert; Aufrufe verwenden weiterhin die ursprüngliche Modell-ID.',
    ...
    aliasHint: 'Ändert nur den Anzeigenamen in der Web UI. Reins erhält weiterhin die ursprüngliche Modell-ID.',
  ...
  profiles: {
    ...
    rename: 'Umbenennen',
    delete: 'Loschen',
    switchTo: 'Reins Profile wechseln',
    switchConfirm: 'Dies fuehrt `reins profile use {name}` aus und aendert das aktive Reins CLI Profile. Fortfahren?',
    switchSuccess: 'Aktives Reins Profile ist jetzt "{name}"',
    switchFailed: 'Reins Profile konnte nicht gewechselt werden. Das Gateway muss eventuell manuell neu gestartet werden.',
  ...
  platform: {
    ...
    weixinTokenHint: 'Von Weixin-CLI QR-Anmeldung (reins weixin)',
    accountId: 'Konto-ID',
  ...
  skillsUsage: {
    title: 'Skill-Nutzung',
    subtitle: 'Skill-Ladevorgänge und -Bearbeitungen aus Reins-Sitzungen verfolgen',
    refresh: 'Aktualisieren',
  ...
  changelog: {
    ...
    new_0_6_3_2: 'History bietet jetzt Controls zum Import von Reins-CLI-Sessions in die lokale Web-UI-Historie mit sichererer Nachrichten-Normalisierung',
    ...
    new_0_6_3_4: 'OpenRouter-Anfragen über die Web-UI-Bridge enthalten jetzt Reins Web UI App-Attribution-Header',
    ...
    new_0_6_2_10: 'Die Standard-Kontextlänge folgt jetzt dem Reins-Standard von 256.000 Tokens',
    ...
    new_0_5_34_2: 'Benutzerdefinierte Reins-Modelle werden über backendverwaltete Konfiguration persistiert, mit neuen Endpunkten zum Hinzufügen und Entfernen',
    ...
    new_0_5_34_8: 'Wenn Kanban unter Windows fehlschlägt, aktualisieren Sie Reins, um die neuesten Migration-Fixes für die Kanban-Datenbank zu erhalten',
    ...
    new_0_6_0_1: 'Account- und Profile-bezogene Verwaltung schützt Sessions, Modelle, Nutzung, Kanban, Jobs, Uploads, Medien und verwandte Reins APIs konsistent',
    ...
    new_0_6_0_3: 'Einzelchat und Gruppenchat injizieren das aktuelle Reins Profile in Run-Instructions, damit Skills X-Reins-Profile senden können',
    ...
    new_0_6_1_2: 'Clarify- und Bestätigungsantworten laufen jetzt über den authentifizierten Chat-Socket zur Reins Bridge, inklusive Tests für den Antwortpfad',
