export default {
  ...
  sidebar: {
    ...
    updateTip: 'Descargar e instalar la ultima version de Reins',
    updateVersion: 'Actualizar a v{version}',
    reloadClientVersion: 'Recargar para v{version}',
    updating: 'Actualizando...',
    updateSuccess: 'La actualizacion ha comenzado. Reins se reiniciara automaticamente.',
  ...
  chat: {
    ...
    contextEditHint: 'Valores comunes: 256k (Reins predeterminado), 128k (GPT-4), 32k (GPT-3.5)',
    ...
    emptyState: 'Inicia una conversacion con Reins Agent',
    ...
    hermesHistory: 'Historial de Reins',
    historyScopeHint: 'Sesiones del historial de Reins del perfil actual, de solo lectura y agrupadas por origen.',
    ...
    searchScope: 'Alcance de búsqueda: solo base de datos local de sesiones de Web UI; no incluye sesiones históricas Reins de solo lectura.',
...
jobTriggered: 'Job ejecutado',
  ...
  plugins: {
    title: 'Plugins',
    refresh: 'Actualizar',
    notice: 'Inventario de solo lectura de manifests de plugins Reins detectables. Los metadatos de descubrimiento se leen sin cargar código de plugins. En v1, la gestión permanece en CLI; los cambios se aplican en nuevas sesiones Reins.',
  ...
  models: {
    ...
    copilotAddDetected: 'Se detectó un token OAuth de GitHub Copilot en este equipo. Haz clic en Agregar para habilitar Copilot en Reins.',
    copilotAddSourceEnv: 'Origen: ~/.reins/.env (COPILOT_GITHUB_TOKEN)',
    copilotAddSourceGhCli: 'Origen: gh CLI (gh auth token)',
    copilotAddSourceAppsJson: 'Origen: extensión Copilot de VS Code (apps.json)',
    copilotDeleteHintEnv: 'Esto borrará COPILOT_GITHUB_TOKEN en ~/.reins/.env. Otras herramientas no se verán afectadas.',
    copilotDeleteHintGhCli: 'Copilot se ocultará de Reins. Tu sesión de gh CLI no se verá afectada — `gh auth status` seguirá mostrando que estás conectado.',
    copilotDeleteHintAppsJson: 'Copilot se ocultará de Reins. La extensión Copilot de VS Code seguirá conectada.',
    ...
    visibilityHint: 'Solo afecta al selector de modelos y a la página de modelos de Web UI. No modifica la configuración provider/model de Reins CLI; las llamadas siguen usando el ID original del modelo.',
    ...
    aliasHint: 'Solo cambia el nombre visible en Web UI. Reins sigue recibiendo el ID original del modelo.',
    aliasEdit: 'Renombrar',
  ...
  profiles: {
    ...
    rename: 'Renombrar',
    delete: 'Eliminar',
    switchTo: 'Cambiar Reins Profile',
    switchConfirm: 'Esto ejecutara `reins profile use {name}` y cambiara el active profile de Reins CLI. Continuar?',
    switchSuccess: 'Reins active profile cambiado a "{name}"',
    switchFailed: 'Error al cambiar Reins Profile. Es posible que la pasarela necesite un reinicio manual.',
  ...
  platform: {
    ...
    weixinTokenHint: 'Desde el inicio de sesion QR de la CLI de weixin (reins weixin)',
  ...
  skillsUsage: {
    ...
    subtitle: 'Sigue las cargas y ediciones de habilidades en sesiones de Reins',
    refresh: 'Actualizar',
  ...
  changelog: {
    ...
    new_0_6_3_2: 'History ahora incluye controles para importar sesiones de Reins CLI al historial local de Web UI con normalizacion de mensajes mas segura',
    ...
    new_0_6_3_4: 'Las solicitudes OpenRouter enviadas por el bridge de Web UI ahora incluyen headers de atribucion de la app Reins Web UI',
    ...
    new_0_6_2_10: 'La longitud de contexto predeterminada ahora sigue el estándar Reins de 256.000 tokens',
    ...
    new_0_5_34_2: 'Persiste modelos Reins personalizados en configuración gestionada por backend y añade endpoints para agregar/eliminar modelos',
    ...
    new_0_5_34_8: 'Si Kanban falla en Windows, actualiza Reins para recibir las últimas correcciones de migración de la base Kanban',
    ...
    new_0_6_0_1: 'La gestión por cuenta y por Profile protege de forma coherente sesiones, modelos, uso, Kanban, jobs, subidas, medios y APIs Reins relacionadas',
    ...
    new_0_6_0_3: 'El chat individual y el grupal inyectan el Reins Profile actual en las instrucciones del run para que los Skills envíen X-Reins-Profile',
    ...
    new_0_6_1_2: 'Las respuestas de Clarify y confirmación ahora viajan por el socket de chat autenticado hasta Reins bridge, con pruebas de la ruta de respuesta',
