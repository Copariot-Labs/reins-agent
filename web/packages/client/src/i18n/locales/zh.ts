export default {
  ...
  sidebar: {
    ...
    collapse: '收起菜单',
    expand: '展开菜单',
    updateTip: '下载并安装最新版本的 Reins',
    updateVersion: '升级版本 v{version}',
    reloadClientVersion: '刷新到 v{version}',
    updating: '正在更新...',
    updateSuccess: '更新已开始，完成后 Reins 将自动重启。',
    updateFailed: '更新失败',
    logout: '退出登录',
  ...
  workmode: {
    ...
    form: {
      task: '任务',
      placeholder: '输入需要后台执行、可见展示和产物记录的任务。',
    },
    examples: {
      report: '为居民漏水报修生成处置报告',
      browser: '打开浏览器证据用于政策查询',
      wechat: '准备微信消息并等待确认',
    },
    status: {
      label: '状态',
  ...
  finance: {
    ...
    form: {
      addTitle: '添加交易',
      editTitle: '编辑交易',
      requiredHint: '标有 * 的项目为必填项，标有“可选”的项目可不填写。',
      optionalLabel: '{label}（可选）',
      type: '类型',
      typePlaceholder: '请选择交易类型',
      amount: '金额',
      amountPlaceholder: '请输入金额',
      currency: '币种',
      currencyPlaceholder: '请输入币种代码',
      date: '日期',
      category: '分类',
      categoryPlaceholder: '选择或输入分类',
      paymentMethod: '支付方式',
      paymentMethodPlaceholder: '选择或输入支付方式',
      description: '描述',
      descriptionPlaceholder: '请输入交易描述',
      counterparty: '交易对象',
      counterpartyPlaceholder: '请输入交易对象（可选）',
      amountRequired: '请输入大于零的金额。',
      currencyRequired: '请输入币种。',
      dateRequired: '请选择交易日期。',
      categoryRequired: '请输入分类。',
      descriptionRequired: '请输入描述。',
      descriptionTooLong: '描述不能超过 {max} 个字。',
    },
  },
  ...
  workOrders: {
    ...
    exportSuccess: 'Excel 台账已下载',
    exportFailed: '下载 Excel 台账失败',
    actions: {
      refresh: '刷新',
    ...
    filters: {
      searchPlaceholder: '搜索工单、地点、问题或员工',
      status: '处理状态',
      priority: '优先级',
      department: '负责部门',
      category: '问题类别',
