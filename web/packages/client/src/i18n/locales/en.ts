export default {
  ...
  workmode: {
    ...
    form: {
      task: 'Task',
      placeholder: 'Enter a task for backend execution, visible actions, and artifact reporting.',
    },
    examples: {
      report: 'Generate an operations report for a resident water leak case',
      browser: 'Open browser evidence for a policy lookup',
      wechat: 'Prepare a WeChat message and require confirmation',
    },
    status: {
      label: 'Status',
      mode: 'Mode',
    ...
    messages: {
      ...
      finished: 'Work mode run completed',
  ...
  finance: {
    ...
    form: {
      ...
      requiredHint: 'Fields marked * are required. Fields marked “Optional” may be left blank.',
      optionalLabel: '{label} (Optional)',
      type: 'Type',
      typePlaceholder: 'Select a transaction type',
      amount: 'Amount',
      amountPlaceholder: 'Enter an amount',
      currency: 'Currency',
      currencyPlaceholder: 'Enter a currency code',
      date: 'Date',
      category: 'Category',
      categoryPlaceholder: 'Choose or type a category',
      paymentMethod: 'Payment Method',
      paymentMethodPlaceholder: 'Choose or type a payment method',
      description: 'Description',
      descriptionPlaceholder: 'Enter a transaction description',
      counterparty: 'Counterparty',
      counterpartyPlaceholder: 'Enter a counterparty (optional)',
      amountRequired: 'Enter an amount greater than zero.',
      currencyRequired: 'Enter a currency.',
      dateRequired: 'Choose a transaction date.',
  ...
  workOrders: {
    ...
    detailFailed: 'Failed to load work order details',
    exportSuccess: 'Excel workbook downloaded',
    exportFailed: 'Failed to download the Excel workbook',
    actions: {
      refresh: 'Refresh',
    ...
    stats: {
      ...
      urgent: 'Urgent',
      notificationFailed: 'Notify errors',
      completed: 'Completed',
    },
    filters: {
      searchPlaceholder: 'Search ticket, location, issue, or staff',
      status: 'Status',
      priority: 'Priority',
    ...
    table: {
      ...
      assignee: 'Assignee',
      location: 'Location',
      issue: 'Resident request',
      notification: 'Notification',
      updatedAt: 'Updated',
    },
    states: {
      noDatabase: 'No work-order ledger was found.',
    },
    labels: {
      unknown: 'Unknown',
      notSent: 'Not sent',
    ...
    status: {
      new: 'New',
      open: 'Pending',
      pendingNotification: 'Awaiting notification',
      waitingHumanReview: 'Needs review',
      notified: 'Notified',
      processing: 'Processing',
      resolved: 'Resolved',
      closed: 'Closed',
    ...
    notification: {
      sent: 'Sent',
      dryRun: 'Preview',
      pendingConfiguration: 'Configuration needed',
