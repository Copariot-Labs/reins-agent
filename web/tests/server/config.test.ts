...
import { getDataDir, getListenHost, getWebUiHome } from '../../packages/server/src/config'
...
describe('server config', () => {
  ...
  it('stores installed desktop data outside the application resources', () => {
    const home = join('C:', 'Users', 'Tester', 'AppData', 'Local', 'Reins')
    expect(getDataDir({ REINS_DESKTOP: '1' }, home)).toBe(join(home, 'data'))
  })
})
